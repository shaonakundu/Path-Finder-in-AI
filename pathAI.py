...
def design():
    ...
    def solution():                                         # backend script is called
        ...
        for value in parent:
            button_list[value].config(bg='blue')         # path color is turned blue
        button_list[src].config(bg='yellow')               # starting pt color is turned back yellow
